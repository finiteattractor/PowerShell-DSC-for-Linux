...
def get_options_and_arguments():
    parser = OptionParser(
        usage="usage: %prog [--register, --deregister] -e endpoint -k key -g groupname -w workspaceid [-r gpgkeyring]",
    ...
    parser.add_option("-r", "--gpg-keyring", dest="gpg_keyring", help="GPG keyring path")
